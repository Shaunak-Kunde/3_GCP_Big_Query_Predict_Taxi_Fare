...
#Task 3._Select features and_create your training dataset
#standardSQL
WITH params AS (
    SELECT
    1 AS TRAIN,
...
#Task 5._Select a BigQuery ML model type_and specify options
...
#Task_6. Evaluate classification model performance
#standardSQL
SELECT
...
#Task_8. Improving the model with_Feature Engineering
#Now_view the common statistics_for taxi cab fares.
SELECT
...
#Limit_the data_to only fares between_$$6 and_$$200.
SELECT
  COUNT(fare_amount) AS num_fares,
  MIN(fare_amount) AS low_fare,
  MAX(fare_amount) AS high_fare,
...
#mit the distance traveled so you are really focusing_on New York City.
